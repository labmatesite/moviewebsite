		...
		<!-- /w3l-medile-movies-grids -->
				...
				<div class="col-sm-8 single-left">
					...
					<div class="song">
						...
						<div class="video-grid-single-page-agileits">
							<div data-video="dLmKio67pVQ" id="video"> <img src="https://image.tmdb.org/t/p/w500/<?= $mdmovie['backdrop_path']; ?>" alt="" class="img-responsive" /> </div>
						</div>
						<p><?= $mdmovie['overview'] ?></p>
					</div>
			...
			<div class="col-md-4 single-right">
					...
					<div class="single-grid-right">
						<?php foreach ($ucmovie as $key => $value) { ?>
						<div class="single-right-grids">
							<div class="col-md-4 single-right-grid-left">
								<a href="<?= base_url('movie-details/').$value['id']; ?>"><img src="https://image.tmdb.org/t/p/w500/<?= $value['poster_path']; ?>" alt="" /></a>
							</div>
							<div class="col-md-8 single-right-grid-right">
								<a href="<?= base_url('movie-details/').$value['id']; ?>" class="title"> <?= $value['title'] ?></a>
								<p class="author"><a href="#" class="author"></a></p>
								<p class="views"><?= $value['vote_count'] ?></p>
							</div>
							<div class="clearfix"> </div>
						</div>
					<?php } ?>
